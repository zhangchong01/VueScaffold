    ...
    <section>
        ...
        <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
            <el-form :inline="true" :model="param">
                ...
                <el-form-item>
                    <el-button type="primary" size="small">编辑病历</el-button>
                </el-form-item>
                <el-form-item>
                    <el-button type="primary" size="small">导入病历</el-button>
                </el-form-item>
                <el-form-item>
                    <el-button type="primary" size="small">导出病历</el-button>
                </el-form-item>
            </el-form>
        </el-col>

        <!--列表-->
        <el-table id="record" :data="records" highlight-current-row v-loading="listLoading">
